...
cacti_log('flowview_get_owner_from_arin: ' . print_r($host, true), false, 'FLOWVIEW');
...
cacti_log('arin query: ' . print_r($ch, true), false, 'FLOWVIEW');
	$response = curl_exec($ch);
cacti_log('arin: ' . print_r($response, true), false, 'FLOWVIEW');
...
cacti_log('arin json: ' . print_r($json, true), false, 'FLOWVIEW');
